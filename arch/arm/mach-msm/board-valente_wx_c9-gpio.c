...
static struct msm_gpiomux_config valente_wx_c9_gsbi_configs[] __initdata = {
	{
		.gpio      = VALENTE_WX_C9_TP_I2C_SDA,	/* GSBI3 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi3,
		},
	},
	{
		.gpio      = VALENTE_WX_C9_TP_I2C_SCL,	/* GSBI3 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi3,
		},
	},
#if 0	/* active in cam_settings */
	{
		.gpio      = VALENTE_WX_C9_CAM_I2C_SDA,	/* GSBI4 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi4,
		},
	},
	{
		.gpio      = VALENTE_WX_C9_CAM_I2C_SCL,	/* GSBI4 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi4,
		},
	},
#endif
	{
		.gpio	   = VALENTE_WX_C9_MC_I2C_SDA,	/* GSBI8 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi8,
		},
	},
	{
		.gpio	   = VALENTE_WX_C9_MC_I2C_SCL,	/* GSBI8 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi8,
		},
	},
...
static struct msm_gpiomux_config valente_wx_c9_audio_codec_configs[] __initdata = {
	{
		.gpio = VALENTE_WX_C9_AUD_WCD_MCLK_CPU,
		.settings = {
...
static struct msm_gpiomux_config valente_wx_c9_slimbus_configs[] __initdata = {
	{
		.gpio	= VALENTE_WX_C9_AUD_WCD_SB_CLK_CPU,		/* slimbus data */
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
	{
		.gpio	= VALENTE_WX_C9_AUD_WCD_SB_DATA,		/* slimbus clk */
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
...
struct msm_gpiomux_config wcnss_5wire_interface[] = {
	{
		.gpio = VALENTE_WX_C9_WCN_CMD_DATA2,
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_WCN_CMD_DATA1,
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_active_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_suspend_cfg,
		},
	...
	{
		.gpio = VALENTE_WX_C9_WCN_CMD_DATA0,
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_active_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_suspend_cfg,
		},
	...
	{
		.gpio = VALENTE_WX_C9_WCN_CMD_SET,
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_active_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_suspend_cfg,
		},
	...
	{
		.gpio = VALENTE_WX_C9_WCN_CMD_CLK,
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_active_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_suspend_cfg,
		},
...
static struct msm_gpiomux_config valente_wx_c9_cam_configs[] = {
	...
	{
		.gpio = VALENTE_WX_C9_CAM_I2C_SDA,
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_CAM_I2C_SCL,
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[3],
			[GPIOMUX_SUSPENDED] = &cam_settings[0],
		},
	...
	{
		.gpio      = VALENTE_WX_C9_MCAM_SPI_CLK,
		.settings = {
	...
	{
		.gpio      = VALENTE_WX_C9_MCAM_SPI_CS0,
		.settings = {
	...
	{
		.gpio      = VALENTE_WX_C9_MCAM_SPI_DI,
		.settings = {
			[GPIOMUX_ACTIVE] = &cam_settings[4], /*A FUNC2 8MA*/
	...
	{
		.gpio      = VALENTE_WX_C9_MCAM_SPI_DO,
		.settings = {
			[GPIOMUX_ACTIVE] = &cam_settings[4], /*A FUNC2 8MA*/
			[GPIOMUX_SUSPENDED] = &cam_settings[2], /*O(L) 8MA*/
		},
...
static struct msm_gpiomux_config valente_wx_c9_felica_configs[] = {
	{
		.gpio = VALENTE_WX_C9_FEL_PON,  /* PON (GPIO-25), output */
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_FEL_RFS, /* RFS (GPIO-10), input */
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_FEL_INT, /* INT (GPIO-24), input */
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_FEL_CON,  /* CON (GPIO-13), input */
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_FEL_CEN,  /* CEN (GPIO-12), output */
		.settings = {
			[GPIOMUX_ACTIVE]    = &felica_settings[3],	/* 3: I(PU) 2MA*/
			[GPIOMUX_SUSPENDED] = &felica_settings[3],	/* 3: I(PU) 2MA*/
		},
...
static struct msm_gpiomux_config valente_wx_c9_mdp_vsync_configs[] __initdata = {
	{
		.gpio = VALENTE_WX_C9_LCD_TE,
		.settings = {
...
static struct msm_gpiomux_config valente_wx_c9_hdmi_configs[] __initdata = {
	{
		.gpio = VALENTE_WX_C9_HDMI_DDC_CLK,
		.settings = {
	...
	{
		.gpio = VALENTE_WX_C9_HDMI_DDC_DATA,
		.settings = {
			[GPIOMUX_ACTIVE]    = &hdmi_active_1_cfg,
			[GPIOMUX_SUSPENDED] = &hdmi_suspend_np_cfg,
		},
...
#endif
	msm_gpiomux_install(valente_wx_c9_mdp_vsync_configs,
			ARRAY_SIZE(valente_wx_c9_mdp_vsync_configs));
...
#ifdef CONFIG_FELICA_DD
	msm_gpiomux_install(valente_wx_c9_felica_configs,
			ARRAY_SIZE(valente_wx_c9_felica_configs));
#endif	/* #ifdef CONFIG_FELICA_DD */
